...
use oxideterm_ai::{
    ...
    ai_required_tool_retry_prompt, ai_should_retry_required_tool_round,
    ai_should_trigger_hard_deny, ai_user_explicitly_requested_json, ai_visible_suggestion_content,
