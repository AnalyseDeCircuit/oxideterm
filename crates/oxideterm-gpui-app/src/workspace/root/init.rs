...
impl WorkspaceApp {
    ...
    pub(in crate::workspace) fn terminal_preferences_for_background_key(
        ...
        TerminalUiPreferences {
            ...
            reading_labels: oxideterm_gpui_terminal::TerminalReadingLabels {
                no_commands: self.i18n.t("terminal.reading.no_commands"),
                no_results: self.i18n.t("terminal.reading.no_results"),
                exit_code: self.i18n.t("terminal.reading.exit_code"),
                outline: self.i18n.t("terminal.reading.outline"),
                search: self.i18n.t("terminal.reading.search"),
                all: self.i18n.t("terminal.reading.all"),
                failed: self.i18n.t("terminal.reading.failed"),
                running: self.i18n.t("terminal.reading.running"),
                unknown: self.i18n.t("terminal.reading.unknown"),
                unavailable: self.i18n.t("terminal.reading.unavailable"),
                truncated: self.i18n.t("terminal.reading.truncated"),
                preview: self.i18n.t("terminal.reading.preview"),
                copy_command: self.i18n.t("terminal.reading.copy_command"),
                copy_output: self.i18n.t("terminal.reading.copy_output"),
                close: self.i18n.t("terminal.reading.close"),
                paste_edit: self.i18n.t("terminal.reading.paste_edit"),
                edit: self.i18n.t("terminal.reading.edit"),
                paste: self.i18n.t("terminal.reading.paste"),
                send_to_sender: self.i18n.t("terminal.reading.send_to_sender"),
                cancel: self.i18n.t("terminal.reading.cancel"),
                undo: self.i18n.t("terminal.reading.undo"),
                redo: self.i18n.t("terminal.reading.redo"),
                remove_numbers: self.i18n.t("terminal.reading.remove_numbers"),
                remove_prefix: self.i18n.t("terminal.reading.remove_prefix"),
                prefix: self.i18n.t("terminal.reading.prefix"),
                tabs_to_spaces: self.i18n.t("terminal.reading.tabs_to_spaces"),
                spaces_to_tabs: self.i18n.t("terminal.reading.spaces_to_tabs"),
                lf: self.i18n.t("terminal.reading.lf"),
                crlf: self.i18n.t("terminal.reading.crlf"),
                invalid_transform: self.i18n.t("terminal.reading.invalid_transform"),
                tools: self.i18n.t("terminal.reading.tools"),
                timestamp: self.i18n.t("terminal.reading.timestamp"),
                utc: self.i18n.t("terminal.reading.utc"),
                local: self.i18n.t("terminal.reading.local"),
                decimal: self.i18n.t("terminal.reading.decimal"),
                binary: self.i18n.t("terminal.reading.binary"),
                copy: self.i18n.t("terminal.reading.copy"),
                archive: self.i18n.t("terminal.reading.archive"),
                path: self.i18n.t("terminal.reading.path"),
                shell: self.i18n.t("terminal.reading.shell"),
                choose_shell: self.i18n.t("terminal.reading.choose_shell"),
                generate: self.i18n.t("terminal.reading.generate"),
                markers: self.i18n.t("terminal.reading.markers"),
                clear_markers: self.i18n.t("terminal.reading.clear_markers"),
                remove: self.i18n.t("terminal.reading.remove"),
                save_rule: self.i18n.t("terminal.reading.save_rule"),
                mark_selection: self.i18n.t("terminal.reading.mark_selection"),
                yellow: self.i18n.t("terminal.reading.yellow"),
                blue: self.i18n.t("terminal.reading.blue"),
                green: self.i18n.t("terminal.reading.green"),
                pink: self.i18n.t("terminal.reading.pink"),
                select_rule_set: self.i18n.t("terminal.reading.select_rule_set"),
            },
