...
use oxideterm_settings_model::{
    ...
    AiSettingsSection, AiToolPolicyGroup, CliCompanionStatus, KNOWLEDGE_EMBEDDING_BATCH_SIZE,
    KnowledgeDeleteTarget, KnowledgeExternalEdit, SETTINGS_SECTION_HEADER_ITEM_COUNT,
    SettingsDynamicSectionCounts, SettingsInputDraftApply, TERMINAL_THEME_COLOR_FIELDS,
    ThemeColorField, ThemeEditorSection, ThemeEditorState, UI_THEME_COLOR_FIELDS, ai_add_acp_agent,
    ai_add_acp_agent_preset, ai_context_max_chars_label_key, ai_context_visible_lines_label_key,
