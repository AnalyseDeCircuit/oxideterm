impl WorkspaceApp {
    ...
    fn render_privilege_credentials_section(
        ...
        // Keep the saved-connection editor focused on connection properties.
        // Privilege credentials share one settings surface across local shell
        // and SSH scopes, so this section only links to that owner.
        div()
            .flex()
            .flex_col()
            .gap(px(12.0))
            ...
            .child(
                div()
                    ...
                    .when_some(scope_id, |header, scope_id| {
                            ...
                            .child(
                                div()
                                    ...
                                    .child(self.i18n_replace(
                                        ...
                                        &[(
                                            "count",
                                            form.privilege_credentials.len().to_string(),
                                        )],
                                    )),
                            )
                            .child(
