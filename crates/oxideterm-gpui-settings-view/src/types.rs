...
impl SettingsInput {
    pub fn anchor_key(self) -> u64 {
        match self {
            ...
            Self::LocalGitBashPath => 5,
            Self::LocalOhMyPoshTheme => 6,
            Self::ConnectionDefaultUsername => 7,
            Self::ConnectionDefaultPort => 8,
            Self::ConnectionNewGroup => 9,
            Self::SftpSpeedLimitKbps => 10,
