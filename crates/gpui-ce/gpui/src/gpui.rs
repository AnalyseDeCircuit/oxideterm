// OxideTerm vendor modification: expose virtual-adapter classification to product policy.
...
pub use scene::*;
pub use shared_uri::*;
/// OxideTerm compatibility re-export for existing detached task delays.
pub use smol::Timer;
