...
// OxideTerm deliberately excludes GPUI's browser platform from its vendor closure.
#[cfg(target_family = "wasm")]
compile_error!("OxideTerm's GPUI platform adapter does not support WebAssembly");
