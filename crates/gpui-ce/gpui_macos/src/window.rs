// OxideTerm modifications: supports hidden cursors and bounded input-dispatch lock lifetimes.
    ...
    match event {
        PlatformInput::KeyDown(key_down_event) => {
                    ...
                    && !key_down_event.keystroke.modifiers.platform)
            {
                ...
                // Drop the window-state lock before returning through either dispatch branch.
