...
pub use store::{
    ...
    ConnectionTerminalEncoding, ConnectionTerminalOptions, DeletedConnectionTombstone,
    GLOBAL_UPSTREAM_PROXY_PASSWORD_KEYCHAIN_ID, LOCAL_SHELL_PRIVILEGE_CONNECTION_ID,
    LocalSyncMetadata, ManagedSshKeyInfo, ManagedSshKeyOrigin, ManagedSshKeyUsage,
    PreparedSavedConnectionsSync, PrivilegeCredentialKind, ProxyHopInfo, RemoteDesktopProfile,
    RemoteDesktopProfilesSyncSnapshot, SaveConnectionRequest, SavePrivilegeCredentialRequest,
    SaveRemoteDesktopProfileRequest, SaveSerialProfileRequest, SaveTelnetProfileRequest, SavedAuth,
    SavedConnection, SavedConnectionRuntimeSecrets, SavedConnectionSyncRecord,
