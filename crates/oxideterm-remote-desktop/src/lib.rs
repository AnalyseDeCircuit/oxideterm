...
pub use model::{
    ...
    RemoteDesktopDisplayOptions, RemoteDesktopEndpoint, RemoteDesktopFileConflictPolicy,
    ...
    RemoteDesktopSpiceOptions, RemoteDesktopSpiceSaslMode, RemoteDesktopSpiceTransportSecurity,
