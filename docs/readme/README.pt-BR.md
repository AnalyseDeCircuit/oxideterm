...
<p align="center">
  <img src="https://img.shields.io/badge/version-2.0.14-blue" alt="Versão">
...
| Categoria | Recursos |
|---|---|
| **Terminal e conexões** | Shells locais, SSH, Telnet, serial, painéis, modo de entrada livre, rotas multi-hop e reconexão estável |
