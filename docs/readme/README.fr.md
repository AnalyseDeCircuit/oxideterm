...
<p align="center">
  <strong>Un workspace SSH local-first pour les personnes qui vivent dans le terminal.</strong>
  <br>
...
<details>
<summary><strong>Architecture, internals SSH, reconnexion, IA, forwarding, plugins et plus</strong></summary>
<br>
