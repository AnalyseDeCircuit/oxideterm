...
<p align="center">
  <strong>ターミナルで暮らす人のための local-first SSH ワークスペース。</strong>
  <br>
...
<p align="center">
  <img src="https://img.shields.io/badge/version-1.5.3-blue" alt="バージョン">
...
OxideTerm は **local-first な SSH ワークフロー**に集中しています。ターミナル、ファイル、ポート、転送、軽量編集、AI コンテキストを、自分のマシンとリモートノード中心に扱いたいユーザー向けです。
...
OxideTerm は個人開発者により**ベストエフォート**でメンテナンスされています。バグ報告と再現可能なリグレッションを優先して対応します。機能リクエストは歓迎しますが、必ず実装されるとは限りません。
