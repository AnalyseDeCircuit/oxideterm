...
<p align="center">
  <strong>Không gian làm việc vận hành native có AI cho máy chủ từ xa — native app viết bằng Rust thuần</strong>
  <br>
  Terminal SSH, Telnet, nối tiếp, RDP/VNC, SFTP, chuyển tiếp cổng, Raw TCP/UDP và chỉnh sửa nhẹ trong một không gian làm việc native.
  <br>
...
<p align="center">
  <img src="https://img.shields.io/badge/version-2.0.0--gpui--preview.12-blue" alt="Version">
