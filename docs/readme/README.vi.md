...
> [!WARNING]
> **OxideTerm 2.0 chưa được phát hành dưới dạng phiên bản ổn định.** Nhánh `main` hiện chứa mã nguồn của phiên bản 2.0 sắp phát hành. Phiên bản ổn định mới nhất vẫn là `v1.6.12`; các bản dựng GPUI Preview là bản phát hành trước.
