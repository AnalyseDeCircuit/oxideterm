...
pub fn run() {
    ...
    let builder = builder.invoke_handler(tauri::generate_handler![
        ...
        commands::ssh_list_connection_summaries,
        ...
        commands::trzsz_create_download_directory,
        commands::trzsz_commit_download_directory,
        commands::trzsz_remove_download_directory,
        commands::trzsz_remove_download_file,
        ...
        commands::start_terminal_search_model,
        commands::get_terminal_search_model_snapshot,
        commands::select_terminal_search_match,
        commands::step_terminal_search_match,
        commands::close_terminal_search_model,
        ...
        commands::config::get_serial_profiles,
        ...
        commands::config::save_serial_profile,
        commands::config::move_connections_to_group,
        commands::config::delete_connection,
        commands::config::delete_serial_profile,
        commands::config::delete_connections,
        commands::config::apply_saved_connections_snapshot,
        commands::config::mark_connection_used,
        commands::config::mark_serial_profile_used,
        commands::config::get_connection_password,
        commands::config::list_privilege_credentials,
        commands::config::save_privilege_credential,
        commands::config::delete_privilege_credential,
        commands::config::get_privilege_credential_secret,
        commands::config::create_managed_ssh_key_from_text,
        commands::config::create_managed_ssh_key_from_file,
        commands::config::list_managed_ssh_keys,
        commands::config::rename_managed_ssh_key,
        commands::config::get_managed_ssh_key_usage,
        commands::config::delete_managed_ssh_key,
        commands::config::delete_global_upstream_proxy_password,
        commands::config::get_saved_connection_for_connect,
        commands::config::list_ssh_config_hosts,
        commands::config::resolve_ssh_config_alias,
        commands::config::import_ssh_host,
        commands::config::import_ssh_hosts,
        commands::config::preview_connection_import,
        commands::config::apply_connection_import,
        commands::get_portable_info,
        commands::get_portable_status,
        commands::get_portable_migration_summary,
        commands::frontend_ready,
        commands::get_linux_webview_profile,
        ...
        commands::config::save_global_upstream_proxy_password,
        ...
        commands::ai_chat_get_transcript,
        commands::ai_chat_get_diagnostic_tail,
        ...
        commands::ai_chat_save_message_with_transcript,
        commands::ai_chat_append_transcript_entries,
        commands::ai_chat_append_diagnostic_events,
        ...
        commands::ai_chat_replace_conversation_messages_with_transcript,
